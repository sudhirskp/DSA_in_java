...
public class WordLadder {
            ...
            while (!beginSet.isEmpty() && !endSet.isEmpty()) {
                ...
                for (String word : beginSet) {
                    ...
                    for (int i = 0; i < ch.length; i++) {
                        ...
                        ch[i] = original; // backtrack character
                    }
                }
    ...
    public static void main(String[] args) {
            ...
            System.out.println(obj.ladderLength("hit", "cog", List.of("hot", "dot", "dog", "lot", "log", "cog")));
            System.out.println(obj.ladderLength1("hit", "cog", List.of("hot", "dot", "dog", "lot", "log", "cog")));
            System.out.println(obj.ladderLength3("hit", "cog", List.of("hot", "dot", "dog", "lot", "log", "cog")));
    }
}
